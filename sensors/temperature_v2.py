...
from .tinkerforge.bricklet_temperature_v2 import BrickletTemperatureV2 as Bricklet


class TemperatureSensorV2(Sensor):
    """
    API Wrapper for the Tinkerforge temperature v2.0 bricklet
    """
    UNIT = "K"
    ...
    def sensor_callback_period(self):
        ...
        """
        return self.bricklet.get_temperature_callback_configuration()[0]
    ...
    def set_callback(self):
        ...
        """
        self.bricklet.set_temperature_callback_configuration(self.callback_period, value_has_to_change=True, option='x', min=0, max=0)
