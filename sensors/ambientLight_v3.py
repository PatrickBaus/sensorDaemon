...
class AmbientLightSensorV3(Sensor):
    ...
    def sensor_callback_period(self):
        ...
        """
        return self.bricklet.get_illuminance_callback_configuration()[0]
    ...
    def set_callback(self):
        ...
        """
        self.bricklet.set_illuminance_callback_configuration(period=self.callback_period, value_has_to_change=True, option="x", min=0, max=0)
